...
public class GameInterface : MonoBehaviour
{
    ...
    {
        // Route through SceneTransitionManager for proper fade-to-black + audio crossfade.
        // Fall back to direct load if the manager isn't present (shouldn't happen in normal play).
        if (SceneTransitionManager.Instance != null)
        {
            HidePanel(summaryScreenGroup);
